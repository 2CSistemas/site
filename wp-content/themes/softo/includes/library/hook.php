 ...
 */
//softo_load_default_hooks
function softo_load_default_hooks() {

	$config = softo_WSH()->config( 'default' );
...
/**
 * [softo_main_header_area description]
 *
 * @return [type] [description]
 */

//softo_main_header_area
function softo_main_header_area() {
	...
	//need to change
	if ( $header == 'header_v1' ) {
		softo_template_load( 'templates/header/default-header.php' );
	} elseif ( $header == 'header_v2' ) {
		softo_template_load( 'templates/header/header_v2.php' );
	} elseif ( $header == 'header_v3' ) {
		softo_template_load( 'templates/header/header_v3.php' );
	} else {
		softo_template_load( 'templates/header/default-header.php' );
	}
}
...
/**
 * [softo_main_footer_area description]
 *
 * @return [type] [description]
 */
//softo_main_footer_area
function softo_main_footer_area() {
	...
	//need to change
	if ( $footer == 'footer_v1' ) {
		softo_template_load( 'templates/footer/default-footer.php' );
	} elseif ( $footer == 'footer_v2' ) {
		softo_template_load( 'templates/footer/footer_v2.php' );
	} elseif ( $footer == 'footer_v3' ) {
		softo_template_load( 'templates/footer/footer_v3.php' );
	} elseif ( $footer == 'footer_v4' ) {
		softo_template_load( 'templates/footer/footer_v4.php' );
	} elseif ( $footer == 'footer_v5' ) {
		softo_template_load( 'templates/footer/footer_v5.php' );
	} else {
		softo_template_load( 'templates/footer/default-footer.php' );
	}
}
...
/**
 * [softo_sidebar description]
 *
 * @return [type] [description]
 */
//softo_sidebar
function softo_sidebar( $data ) {

	softo_template_load( 'templates/sidebar.php', compact( 'data' ) );
}

/**
 * [softo_banner description]
 *
 * @return [type] [description]
 */
//softo_banner
function softo_banner( $data ) {

	softo_template_load( 'templates/banner/banner.php', compact( 'data' ) );
