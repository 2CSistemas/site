...
use SOFTO\Includes\Classes\Header_Enqueue;
use SOFTO\Includes\Classes\Options;
...
class Base {
	...
	public static function instance() {
		...
		if ( isset( $GLOBALS['softo_base'] ) ) {
			return $GLOBALS['softo_base'];
		}
	...
	function option( $key = '' ) {
		...
		$options = (array) get_theme_mod( 'softo' . '_options-mods' );

		$dn = softo_dot( $options );
