 ...
 * @since 1.0.0
 */
class Get_In_Touch_V4 extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Get In Touch V4', 'softo' );
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'get_in_touch_v4',
            [
                'label' => esc_html__( 'Get In Touch V4', 'softo' ),
            ]
        );
		$this->add_control(
			'bg_image',
    ...
    <div class="get-in-touch-type2 get-in-touch-style4 parallax parallax2 position-relative clearfix" <?php if($settings['bg_image']['id']){ ?>style="background-image:url(<?php echo esc_url(wp_get_attachment_url($settings['bg_image']['id'])); ?>); "<?php } ?>>
        ...
        <div class="container position-relative">
            ...
            <?php if($settings['get_in_touch_form_v4']){ ?>
            <div id="contactform" class="form-git form-submit">
                <?php echo do_shortcode($settings['get_in_touch_form_v4']);?>
            </div>
			<?php } ?>
        </div>
