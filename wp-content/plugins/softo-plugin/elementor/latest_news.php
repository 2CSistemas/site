...
class Latest_News extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Latest News', 'softo' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'latest_news',
			[
				'label' => esc_html__( 'Latest News', 'softo' ),
			]
		);
		$this->add_control(
			'subtitle',
                        ...
                        <article class="blog-grid blog-grid-type1">    
                            ...
                            <div class="featured-post">    
                                <div class="entry-image">    
                                    <a href="<?php echo esc_url( the_permalink( get_the_id() ) );?>"><?php the_post_thumbnail('softo_370x230'); ?></a>    
                                </div>    
                            </div> 
                            <?php } ?>   
                            <div class="content-inside">    
                                ...
                                <div class="text"><?php echo wp_kses( softo_trim( get_the_content(), $settings[ 'text_limit' ] ), true );?></div>
                                <div class="flat-contact-now btn-linear hv-linear-gradient m-t30">
                                    <a class="font-style linear-color border-corner" href="<?php echo esc_url( the_permalink( get_the_id() ) );?>"> <?php esc_html_e('read more', 'softo'); ?> <span class="icon-arrow-pointing-to-right"></span></a>
                                </div>  
                            </div>    
                        </article>    
                    </div>
