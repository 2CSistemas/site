...
class Google_Map extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Google Map', 'softo' );
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'google_map',
            [
                'label' => esc_html__( 'Google Map', 'softo' ),
            ]
        );
		$this->add_control(
			'google_map_code',
    ...
    protected function render() {
        ...
        <div class="flat-map-type1">
            <div class="container">
                <div class="flat-map"><?php echo do_shortcode($settings['google_map_code']);?></div>
            </div>
        </div>
