...
class Testimonials extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Testimonials', 'softo' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'testimonials',
			[
				'label' => esc_html__( 'Testimonials', 'softo' ),
			]
		);
		$this->add_control(
			'subtitle',
                            ...
                            <div class="owl-carousel">
                                ...
                                <div class="testimonial-box testimonial-box-type1 position-relative">    
                                    <div class="endorser d-sm-flex align-items-center">    
                                        <div class="avatar"><?php the_post_thumbnail('softo_400x400'); ?></div>    
                                        <div class="info">    
                                    ...
                                    <div class="content-testimonial">    
                                        <div class="text-bold">    
                                            <?php echo (get_post_meta( get_the_id(), 'quote_description', true ));?>   
                                        </div>    
                                        <p><?php echo wp_kses(softo_trim(get_the_content(), $settings['text_limit']), true); ?></p>    
                                    </div>    
                                    <div class="spinning-circle"></div>    
                                    <div class="icon-represent"><span class="<?php echo esc_attr(str_replace( "icon ",  "", get_post_meta(get_the_id(), 'testimonials_icon', true))); ?>"></span></div>    
                                </div>
    							<?php endwhile; ?> 
                            </div>    
                        </div>    
