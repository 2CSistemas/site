...
class Latest_News_V2 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Latest News V2', 'softo' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'latest_news_v2',
			[
				'label' => esc_html__( 'Latest News V2', 'softo' ),
			]
		);
		$this->add_control(
			'subtitle',
            ...
            <div class="container">    
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-12 wow fadeInLeft" data-wow-delay="200ms">    
                        <article class="blog-grid blog-grid-type2">    
                            <?php if(has_post_thumbnail()){ ?>
                            <div class="featured-post">    
                                <div class="entry-image">    
                                    <a href="<?php echo esc_url( the_permalink( get_the_id() ) );?>"><?php the_post_thumbnail('softo_310x190'); ?></a>    
                                </div>    
                            </div>
    						<?php } ?>
                            <div class="content-inside clearfix">    
                                <div class="clendar-wrap">    
                                    <div class="day"><?php echo esc_attr(get_the_date('d')); ?></div>    
                                    <div class="month"><?php echo esc_attr(get_the_date('M')); ?></div>    
                                </div>    
                                <div class="text-wrap">    
                                    <h3 class="title"><a href="<?php echo esc_url( the_permalink( get_the_id() ) );?>"><?php the_title(); ?></a></h3>    
                                    <div class="read-more">    
                                        <a href="<?php echo esc_url( the_permalink( get_the_id() ) );?>"><?php esc_html_e('Read More', 'softo'); ?></a>    
                                    </div>    
                                </div>    
                            </div>    
                        </article>    
