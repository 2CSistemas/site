...
class Case_Study extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Case Study', 'softo' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'case_study',
			[
				'label' => esc_html__( 'Case Study', 'softo' ),
			]
		);
		$this->add_control(
			'subtitle',
    ...
    <section class="flat-case-study flat-case-study-type2 flat-case-study-style2">
        <div class="container">
            ...
            <div class="row">
				...
				?>
                <div class="col-lg-4 col-md-6 wow fadeInLeft" data-wow-delay="200ms">
