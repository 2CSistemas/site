...
class Our_Faqs extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Our Faqs', 'softo' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'our_faqs',
			[
				'label' => esc_html__( 'Our Faqs', 'softo' ),
			]
		);
		$this->add_control(
			'text_limit',
	...
	protected function render() {
		...
		if( softo_set( $settings, 'query_category' ) ) $args['faqs_cat'] = softo_set( $settings, 'query_category' );
		$query = new \WP_Query( $args );

		if ( $query->have_posts() ) 
	{ ?>
	
    <div class="faq flat-row">
        <div class="container">
            <div class="wrap-faq">
                <?php 
					while ( $query->have_posts() ) : $query->the_post(); 
                ?>
                <div class="flat-question hv-background-before">
                    <div class="expand-button"><span class="fa fa-angle-down" aria-hidden="true"></span></div>
