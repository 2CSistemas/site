...
class Our_Services_V3 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Our Services V3', 'softo' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'our_services_v3',
			[
				'label' => esc_html__( 'Our Services V3', 'softo' ),
			]
		);
		$this->add_control(
			'subtitle',
    ...
    <div class="flat-it-services flat-it-services-style3">
        <div class="container">
            ...
            <div class="row">
                ...
                ?>
                <div class="col-lg-3 col-md-6 col-12 wow fadeInUp" data-wow-delay="200ms">
                    <div class="service-image-box border-corner">
                        <?php if(has_post_thumbnail()){ ?>
                        <div class="featured-post">
                            <div class="entry-image">
                                <?php the_post_thumbnail('softo_270x165'); ?>
                                <div class="icon-service"><span class="<?php echo esc_attr(str_replace( "icon ",  "", get_post_meta(get_the_id(), 'service_icon', true))); ?>"></span></div>
